  ...
  return {
    ...
    paths: {
      denylist: [
        ...
        "**/.npmrc", "**/.pypirc",
        "**/.config/**/*token", "**/.config/**/*tokens",
        "**/.config/**/access-token", "**/.config/**/refresh-token", "**/.config/**/id-token",
        "**/.config/**/api-token", "**/.config/**/auth-token", "**/.config/**/token-store",
        "**/.config/**/token-cache",
        "**/.config/**/*token*.json", "**/.config/**/*token*.txt", "**/.config/**/*token*.yaml",
        "**/.config/**/*token*.yml", "**/.config/**/*token*.toml", "**/.config/**/*token*.db",
        "**/.config/**/*token*.sqlite", "**/.config/**/*token*.sqlite3", "**/.config/**/*token*.enc",
        "**/.config/**/*token*.key",
        "**/.config/**/credentials", "**/.config/**/auth",
        "**/.config/**/credentials.json", "**/.config/**/credentials.txt",
        "**/.config/**/credentials.yaml", "**/.config/**/credentials.yml",
        "**/.config/**/credentials.toml", "**/.config/**/credentials.db",
        "**/.config/**/credentials.sqlite", "**/.config/**/credentials.sqlite3",
        "**/.config/**/credentials.enc", "**/.config/**/credentials.key",
        "**/.config/**/auth.json", "**/.config/**/auth.txt", "**/.config/**/auth.yaml",
        "**/.config/**/auth.yml", "**/.config/**/auth.toml", "**/.config/**/auth.db",
        "**/.config/**/auth.sqlite", "**/.config/**/auth.sqlite3", "**/.config/**/auth.enc",
        "**/.config/**/auth.key",
      ],
